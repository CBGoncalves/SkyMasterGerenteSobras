...
public class EditarEntradaController {
    @FXML
    ...
    public EditarEntradaController(Registro registro, ItemDao itemDao, ObraDao obraDao) {
    ...
    private void handleEditarButtonAction(ActionEvent event) throws SQLException {
        ...
        int codEntrada = registro.getCodRegistro();
        ...
        registroDao.updateRegistroEntrada(numNotaEntrada, qtdEntrada, tipoItem, descricaoItem, nomeObra, codEntrada);
